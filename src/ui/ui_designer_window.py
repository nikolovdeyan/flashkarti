...
class Ui_DesignerWindow(object):
    def setupUi(self, DesignerWindow):
        ...
        self.new_deck_btn.setCheckable(True)
        ...
        self.load_deck_btn.setCheckable(True)
        ...
        self.exit_designer_btn.setCheckable(True)
        ...
        self.add_card_btn.setCheckable(True)
        ...
        self.delete_card_btn.setCheckable(True)
        ...
        self.save_card_btn.setCheckable(True)
