...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.widget.setGeometry(QRect(20, 250, 558, 33))
        ...
        self.widget1.setGeometry(QRect(20, 210, 558, 33))
        self.horizontalLayout = QHBoxLayout(self.widget1)
        self.horizontalLayout.setObjectName(u"horizontalLayout")
        self.horizontalLayout.setContentsMargins(0, 0, 0, 0)
        self.player_btn = QPushButton(self.widget1)
        ...
        self.player_label = QLabel(self.widget1)
        ...
        self.widget2.setGeometry(QRect(20, 290, 558, 33))
        self.horizontalLayout_3 = QHBoxLayout(self.widget2)
        self.horizontalLayout_3.setObjectName(u"horizontalLayout_3")
        self.horizontalLayout_3.setContentsMargins(0, 0, 0, 0)
        self.designer_btn = QPushButton(self.widget2)
        ...
        self.designer_label = QLabel(self.widget2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.designer_label.setText(QCoreApplication.translate("MainWindow", u"Deck Designer: Coming Soon", None))
