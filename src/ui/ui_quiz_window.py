...
class Ui_QuizWindow(object):
    def setupUi(self, QuizWindow):
        ...
        self.end_quiz_btn = QPushButton(self.centralwidget)
        self.end_quiz_btn.setObjectName(u"end_quiz_btn")
        self.end_quiz_btn.setGeometry(QRect(840, 550, 101, 31))
        sizePolicy.setHeightForWidth(self.end_quiz_btn.sizePolicy().hasHeightForWidth())
        self.end_quiz_btn.setSizePolicy(sizePolicy)
        self.end_quiz_btn.setFont(font1)
    ...
    def retranslateUi(self, QuizWindow):
        ...
        self.actionEnd_Round.setText(QCoreApplication.translate("QuizWindow", u"End Quiz", None))
        ...
        self.end_quiz_btn.setText(QCoreApplication.translate("QuizWindow", u"End Quiz", None))
