...
class Ui_DesignerWindow(object):
    def setupUi(self, DesignerWindow):
        ...
        self.deck_designer_label.setGeometry(QRect(10, 0, 921, 31))
        font = QFont()
        font.setPointSize(16)
        self.deck_designer_label.setFont(font)
        self.deck_designer_label.setAlignment(Qt.AlignCenter)
        ...
        self.deck_cards_listwidget = QListWidget(self.centralwidget)
        self.deck_cards_listwidget.setObjectName(u"deck_cards_listwidget")
        self.deck_cards_listwidget.setGeometry(QRect(10, 50, 231, 481))
        ...
        self.save_deck_btn = QPushButton(self.centralwidget)
        self.save_deck_btn.setObjectName(u"save_deck_btn")
        self.save_deck_btn.setGeometry(QRect(250, 540, 111, 31))
        sizePolicy.setHeightForWidth(self.save_deck_btn.sizePolicy().hasHeightForWidth())
        self.save_deck_btn.setSizePolicy(sizePolicy)
